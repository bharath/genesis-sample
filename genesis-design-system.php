...
class MyTheme_Customize {
	...
	public static function register ( $wp_customize ) {
	   ...
	   $wp_customize->add_section( 'mytheme_options', 
		  array(
			 'title'       => __( 'Theme Design Options', 'obk' ), //Visible title of section
			 'priority'    => 120, //Determines what order this appears in
			 'capability'  => 'edit_theme_options', //Capability needed to tweak
			 'description' => __('Allows you to set custom colors for obk child theme.', 'obk'), //Descriptive tooltip
		  ) 
	   );
	   ...
	   $wp_customize->add_control( new WP_Customize_Color_Control( //Instantiate the color control class
		  ...
		  array(
			 'label'      => __( 'Link Color', 'obk' ), //Admin-visible name of the control
	   ...
	   $wp_customize->add_control( new WP_Customize_Color_Control( //Instantiate the color control class
		  ...
		  array(
			 'label'      => __( 'Link Accent Color', 'obk' ), //Admin-visible name of the control
	...
	public static function live_preview() {
        wp_enqueue_script( 
             'obk-themecustomizer', // Give the script a unique ID
