...
add_action( 'wp_enqueue_scripts', 'genesis_sample_custom_woocommerce_css' );
/**
 ...
 */
function genesis_sample_custom_woocommerce_css() {
	...
	if ( $woo_css ) {
		wp_add_inline_style( genesis_get_theme_handle() . '-custom-woocommerce-styles', $woo_css );
	}
