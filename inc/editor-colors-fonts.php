		...
		add_theme_support(
			...
			[
				[
					...
					'slug'  => 'primary',
					'color' => esc_html( get_theme_mod( 'primary_color', '#0467c6' ) ),
					//'color' => 'var(--ccp-primary)',
				],
				[
					'name'  => esc_html__( 'Secondary', 'genesis-sample' ),
					'slug'  => 'secondary',
					'color' => esc_html( get_theme_mod( 'secondary_color', '#004990' ) ),
					//'color' => 'var(--ccp-secondary)',
				],
				[
					'name'  => esc_html__( 'Primary Alt', 'genesis-sample' ),
					'slug'  => 'primary-alt',
					'color' => esc_html( get_theme_mod( 'primary_alt_color', '#ff0014' ) ),
					//'color' => 'var(--ccp-primary-alt)',
				],
				[
					'name'  => esc_html__( 'Secondary Alt', 'genesis-sample' ),
					'slug'  => 'secondary-alt',
					'color' => esc_html( get_theme_mod( 'secondary_alt_color', '#b3000e' ) ),
